...
PREISE (netto, zzgl. 19% MwSt.)
  ...
  Monatlich ENTERPRISE:     ${f.monatlichPreis} €\n  Service Level ${f.serviceLevel}:       ${TIER_DATA[f.serviceLevel]?.preis || '0,00'} €/Monat
          ...
          {f.setupPreis && f.monatlichPreis && (
            <div style={{ background: '#1E2D40', borderRadius: 10, padding: '16px 22px', marginBottom: 18 }}>
              ...
              <div style={{ display: 'flex', gap: 28, flexWrap: 'wrap' }}>
                {[['Setup (einmalig)', `${f.setupPreis} €`], ['ENTERPRISE / Monat', `${f.monatlichPreis} €`], [`Service Level ${f.serviceLevel}`, `${TIER_DATA[f.serviceLevel]?.preis || '0,00'} €`]].map(([l,v]) => (
                  <div key={l}>
